...
public class MD5Util {
	...
	public static void main(String[] args) throws IOException {
		...
		File big = new File("E:/一站通/YZTSVN/部署文档/YZT/YZTV1.2.1/YZTV1.2.1/01_WEB/yzt-md5.txt");
		...
		File big1 = new File("E:/一站通/YZTSVN/部署文档/YZT/YZTV1.2.1/YZTV1.2.1/01_WEB/yzt-md5.txt");
		String md51 = getFileMD5String(big1);
		System.out.println("md5:" + md51.toUpperCase() + " time:" + ((end - begin) / 1000) + "s");
