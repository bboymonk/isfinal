...
var UNDEFINED,
	...
	SVG_NS = 'web://www.w3.org/2000/svg',
...
defaultOptions = {
	...
	global: {
		useUTC: true,
		canvasToolsURL: 'web://code.highcharts.com/3.0.6/modules/canvas-tools.js',
		VMLRadialGradientURL: 'web://code.highcharts.com/3.0.6/gfx/vml-radial-gradient.png'
	},
	chart: {
		//animation: true,
		//alignTicks: false,
...
SVGRenderer.prototype = {
	...
	image: function (src, x, y, width, height) {
		...
		if (elemWrapper.element.setAttributeNS) {
			elemWrapper.element.setAttributeNS('web://www.w3.org/1999/xlink',
				'href', src);
		} else {
...
if (useCanVG) {
	...
	Highcharts.CanVGRenderer = CanVGRenderer = function () {
		...
		SVG_NS = 'web://www.w3.org/1999/xhtml';
	};
