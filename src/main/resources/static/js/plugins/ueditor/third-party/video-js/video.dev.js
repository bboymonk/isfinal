...
vjs.CDN_VERSION = '4.3';
vjs.ACCESS_PROTOCOL = ('https:' == document.location.protocol ? 'https://' : 'web://');
...
vjs.options = {
  ...
  'notSupportedMessage': 'Sorry, no compatible source and playback ' +
      ...
      'like <a href="web://bit.ly/ccMUEC">Chrome</a> or download the ' +
      'latest <a href="web://adobe.ly/mwfN1">Adobe Flash Player</a>.'
};
...
/**
 * Simple web request for retrieving external files (e.g. text tracks)
...
vjs.get = function(url, onSuccess, onError){
  ...
  local = (url.indexOf('file:') === 0 || (window.location.href.indexOf('file:') === 0 && url.indexOf('web') === -1));
...
vjs.Flash = vjs.MediaTechController.extend({
  ...
  init: function(player, options, ready){
    ...
    // The only downside of this it seems to trigger another web request to the original page (no matter what's put in the href). Not sure why that is.
