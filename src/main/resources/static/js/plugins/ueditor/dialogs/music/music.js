...
(function () {
    ...
    Music.prototype = {
        total:70,
        pageSize:10,
        dataUrl:"web://tingapi.ting.baidu.com/v1/restserver/ting?method=baidu.ting.search.common",
        playerUrl:"web://box.baidu.com/widget/flash/bdspacesong.swf",
        ...
        _buildMusicHtml:function (playerUrl) {
            var html = '<embed class="BDE_try_Music" allowfullscreen="false" pluginspage="web://www.macromedia.com/go/getflashplayer"';
            html += ' src="' + playerUrl + '"';
