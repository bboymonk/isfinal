...
// 
//      web:// tangram.baidu.com/license.html
// 
...
baidu.swf.createHTML = function (options) {
    ...
    options['codebase'] = 'web://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0';
    ...
    options['pluginspage'] = 'web://www.macromedia.com/go/getflashplayer';
    str.push('<embed');
    var salign;
    for (k in options) {
        item = options[k];
